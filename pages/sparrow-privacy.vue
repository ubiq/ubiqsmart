<template>
  <v-row class="justify-content-md-center">
    <v-col md="12">
      <v-card class="card-main" style="padding: 20px">
        <div class="text-center">
          <v-row class="justify-content-md-center d-done d-md-block">
            <img src="/sparrow/icon-128.png" height="120" />
          </v-row>
          <h3>SPARROW PRIVACY POLICY</h3>
          <h4>Last Updated: November 1st, 2020</h4>
        </div>
        <p>
          Ubiq recognizes that people who use Sparrow value their privacy. This
          privacy policy (“<strong>Policy</strong>”) describes how Sparrow
          (“<strong>Company</strong>”, “<strong>we</strong>”,
          “<strong>our</strong>”, or “<strong>us</strong>”) collects, uses,
          shares, and stores personal information of users of our website,
          <a href="https://ubiqsmart.com"
            ><strong>https://ubiqsmart.com/</strong></a
          >
          and our mobile application, &nbsp;(collectively the
          “<strong>Site</strong>”). This Policy applies to the Site,
          applications, products and services (collectively,
          “<strong>Services</strong>”) on or in which it is posted, linked, or
          referenced.
        </p>
        <p>
          ...
          class or representative action. IF YOU DO NOT AGREE WITH ANY PART OF
          THIS PRIVACY POLICY OR OUR TERMS OF USE, THEN PLEASE DO NOT USE ANY OF
          THE SERVICES.
        </p>
        <p>
        ...
        <p>
          <strong>Information You Give Us.</strong> Information we collect from
          you includes:
        </p>
        <ul>
        ...
        <p>
          ...
          information about you from other third party sources and we may add
          this to information we get from your use of the Services. Such
          information may include:
        </p>
        <ul role="list">
          <li>
            <strong>Social Media Widgets: </strong>Our Site may include social
            media features, such as the Facebook “like” button and widgets, such
            as the “share this” button. These features may collect your personal
            information and track your use of the Site. These social media
            features are either hosted by a third party or hosted directly on
            our Site. Your interactions with these features are governed by the
            privacy policy of the company providing such functionality.
          </li>
        </ul>
        <p>
          <strong>Information Automatically Collected.</strong> We may
          automatically record certain information about how you use our Site
          (we refer to this information as “Log Data“). Log Data may include
          information such as a user’s Internet Protocol (IP) address, device
          and browser type, operating system, the pages or features of our Site
          to which a user browsed and the time spent on those pages or features,
          ...
          functionality and tailoring it to our users’ needs and preferences.
        </p>
        <p>
          ...
          a whole. Users can control the use of cookies and local storage at the
          individual browser level. For more information, please see the
          sections entitled “Cookies Policy and “Local Storage Policy”” below.
        </p>
        <p>
          <strong>Information we will never collect</strong>. We will never ask
          you to share your private keys or wallet seed. Never trust anyone or
          any site that asks you to enter your private keys or wallet seed.
        </p>
        ...
        <p>We do not share or sell the personal information</p>
        ...
        <p><strong>Tracking Technologies Generally</strong></p>
        <p>
        ...
        <p>
          ...
          questions about this Policy, and you may contact us at:
          marketing@ubiqsmart.com.
        </p>
        <p>
          <strong>CHANGES TO THIS PRIVACY POLICY.</strong> We may change this
          privacy policy at any time. We encourage you to periodically review
          this page for the latest information on our privacy practices. If we
        ...
        <p>
          ...
          requirements of the Children's Online Privacy Protection Act (COPPA),
          if we learn that we have received any information directly from a
          child under age 13 without first receiving his or her parent's
          verified consent, we will use that information only to respond
          directly to that child (or his or her parent or legal guardian) to
          inform the child that he or she cannot use the Site and subsequently
        ...
        <p>
          ...
          personal information, contact us at marketing@ubiqsmart.com.
        </p>
        <p>
        ...
        <p>
          ...
          make sure we consider and balance any potential impacts on you (both
        ...
        <p>
          ...
          you have the right to withdraw it anytime in the manner indicated in
          the Service or by contacting us at marketing@ubiqsmart.com.
        </p>
        <p>
          <strong><em>Use for New Purposes</em></strong>
        </p>
        <p>
        ...
        <p>
          <strong><em>Do we use Cookies?</em></strong>
        </p>
        <p>
        ...
        <p>
          <strong><em>What is a Cookie?</em></strong>
        </p>
        <p>
          A cookie (“Cookie”) is a small text file that is placed on your hard
          drive by a web page server. Cookies contain information that can later
          be read by a web server in the domain that issued the cookie to you.
          Some of the cookies will only be used if you use certain features or
          select certain preferences, and some cookies will always be used. You
          can find out more about each cookie by viewing our current cookie list
          below. We update this list periodically, so there may be additional
          cookies that are not yet listed. Web beacons, tags and scripts may be
          used in the Site or in emails to help us to deliver cookies, count
        ...
        <p>
          <strong><em>Why do we use Cookies?</em></strong>
        </p>
        ...
        <p>
          ...
          analysis and marketing purposes. &nbsp;Functional Cookies enable
          certain parts of the site to work properly and your user preferences
          to remain known. &nbsp;Analysis Cookies, among other things, collect
          information on how visitors use our Site, the content and products
          that users view most frequently, and the effectiveness of our third
          party advertising. Advertising Cookies assist in delivering ads to
          relevant audiences and having our ads appear at the top of search
          results. Cookies are either “session” Cookies which are deleted when
          you end your browser session, or “persistent,” which remain until
          their deletion by you (discussed below) or the party who served the
          cookie. &nbsp;Full details on all of the Cookies used on the Site are
          available at our Cookie Disclosure table below.
        </p>
        <p>
          <strong><em>How to disable Cookies.</em></strong>
        </p>
        <p>
          ...
          about how to control cookie settings through your browser:<br /><br />Click
          <a
            href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences"
            ><strong>here</strong></a
          >
          to learn more about the “Private Browsing” setting and managing cookie
          settings in Firefox;<br /><br />Click
          <a
            href="https://support.google.com/chrome/answer/95647?hl%3Den&amp;sa=D&amp;ust=1527189380727000"
            ><strong>here</strong></a
          >
          to learn more about “Incognito” and managing cookie settings in
          Chrome;<br /><br />Click
          <a
            href="https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies"
            ><strong>here</strong></a
          >
          to learn more about “InPrivate” and managing cookie settings in
          Internet Explorer; or<br /><br />Click
          <a
            href="https://support.apple.com/kb/ph21411?locale%3Den_US&amp;sa=D&amp;ust=1527189380728000"
            ><strong>here</strong></a
          >
          to learn more about “Private Browsing” and managing cookie settings in
          Safari.<br /><br />If you want to learn more about cookies, or how to
          control, disable or delete them, please visit
          <a href="http://www.aboutcookies.org"
            ><strong>http://www.aboutcookies.org</strong></a
          >
          ...
          about this feature from Google, click
          <a href="https://adssettings.google.com/u/0/authenticated?hl=en"
            ><strong>here</strong></a
          >.
        </p>
        <p>
        ...
        <p>
          ...
          to EU Data Subjects”, including the right to inspect and correct or
          delete the data that we have about you.
        </p>
        <p><strong>LOCAL STORAGE POLICY</strong></p>
        <p>
          Local Storage, including Javascript-enabled localStorage, is a typical
          way for a website to store a small file of letters and numbers in your
          browser. We use Local Storage to assign you a unique user ID for
          purposes of communication with you. Local Storage are deleted when the
          website that stored them deletes them. You can also delete Local
          Storage from your browser at any time you like by visiting your web
          browser settings.
        </p>
        <p>Cookies &amp; Local Storage Disclosure</p>
        <table>
          <tr>
            <th>Name of Cookie/Identifier</th>
            <th>
              What does the cookie or local storage generally do (e.g., website
              function and administration, analytics, marketing)?
            </th>
            <th>
              Is it a 1st or 3rd party cookie or local storage entry and what is
              the name of the party providing it?
            </th>
            <th>What type of cookie is it (persistent or session)?</th>
            <th>
              What is the duration of the cookie or local storage on the website
              (if not cleared by the user)?
            </th>
          </tr>
          <tr>
            <td>local storage</td>
            <td>Analytics</td>
            <td>1st - UID set by Sparrow</td>
            <td>N/A</td>
            <td>
              Depends on browser (See “How to Clear Local Storage from Your
              Browser” below)
            </td>
          </tr>
        </table>
        <div class="w-richtext">
          <p>
            <strong
              ><em>How to Clear Local Storage from Your Browser:</em></strong
            >
          </p>
          <ul role="list">
            <li>
              In Firefox, localStorage is cleared when the following conditions
              are met: (a) user clears recent history, (b) cookies are selected
              to be cleared, and (c) time range is “Everything.”
            </li>
            <li>
              In Chrome, localStorage is cleared when the following conditions
              are met: (a) clear browsing data, (b) "cookies and other site
              data" is selected, and (c) timeframe is “from beginning of time.”
              In Chrome, it is also now possible to delete localStorage for one
              specific site.
            </li>
            <li>
              In IE, to clear localStorage: (a) click on Tools--Internet
              Options, (b) General tab, (c) delete browsing history on exit, (d)
              ensure “Cookies and website data” (or “temporary internet files
              and website files”) is selected, and (e) consider unchecking
              "Preserve Favorites website data" at the top.
            </li>
            <li>
              In Safari, (a) Click Safari, (b) Preferences, (c) Select the
              Privacy tab, (d) Click Remove all website data and (e) Click
              Remove Now<br />
            </li>
          </ul>
        </div>
